...
const requestHandler = async (req, res) => {
  ...
  switch (url) {
    ...
    case '/author':
      ...
      // Estableciendo cabeceras
      res.setHeader('Content-Type', 'text/html');
      let url_image = 'https://ap-cdn.sfo3.cdn.digitaloceanspaces.com/uploads/2023/07/oppenheimer-enveneno-manzana-profesor.jpg';
      // Escribiendo la respuesta
      res.write(`
      <html>
      <head>
      ...
      <body style="text-align: center;">
              <h1 style="color: #333;">&#129312; &#129327; AUTOR</h1>
          <p style="color: #C9EA40;">aguilar gonzalez jorge </p>
        <div>
          <img width="450px" src="https://ap-cdn.sfo3.cdn.digitaloceanspaces.com/uploads/2023/07/oppenheimer-enveneno-manzana-profesor.jpg">
           </div>
      </body>
    </html>
      `);
